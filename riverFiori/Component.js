jQuery.sap.declare("sapFioriApp.Component");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("sapFioriApp.Component", {
	metadata : {
		...
		routing: {
			config: {
				viewType : "XML",
				viewPath: "sapFioriApp.view",  // common prefix
	...
	init : function() {
		...
		var rootPath = jQuery.sap.getModulePath("sapFioriApp");
